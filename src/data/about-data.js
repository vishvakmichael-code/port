...
export const trajectory = [
  ...
  },
  {
    ...
    side: 'right',
    content: `Joined Surfboard Payments as a Technical Writer and Developer Relations specialist. Spent a year and a half redesigning their developer portal from the ground up — turning a maze of documents into a service experience developers could actually navigate. First real encounter with designing for a system rather than just writing about one. Then packed up and moved to Latvia to start over in a new discipline.`,
  },
  {
    year: '2023',
    location: 'Chennai, India',
